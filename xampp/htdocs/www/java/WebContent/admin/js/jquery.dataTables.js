 ...
 * ï¿½ï½¾ã‚‘ï½½ï½©2008-2013 SpryMedia Ltd - datatables.net/license
 */
...
(/** @lends <global> */function( $ ) {
	...
	var _re_new_lines = /[\r\n]/g;
	var _re_html = /<.*?>/g;
	var _re_formatted_numeric = /[',$ï¿½ï½¾ã‚‘ï½½ï½£é�¶ï¿½ï½½ï½¬ï¿½ï½¾ã‚‘ï½½ï½¥%]/g;
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Hiện thị từ _START_ đến _END_ trong _TOTAL_ thông tin",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Không có thông tin nào",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Có tát cả _MAX_ thông tin)",
