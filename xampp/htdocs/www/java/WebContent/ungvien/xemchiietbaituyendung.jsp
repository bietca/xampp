...
<body style="background: #eee">
	...
	<div id="wrapper">
		...
		<div class="container"
			...
			<div id="main">
			 <logic:present  name="trangCVDaUngTuyenForm" property="baiTuyenDung1">
				<bean:define id="baiviet" name="trangCVDaUngTuyenForm"
					property="baiTuyenDung1"></bean:define>
		...
		<div class="container" style="margin-top: 10px; margin-left: 133px;">
