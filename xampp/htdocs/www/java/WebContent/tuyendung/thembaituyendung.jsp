...
<head lang="en">
<meta charset="UTF-8">
<title>Thêm bài tuyển dụng</title>
...
<body style="background: #eee">
	...
	<div id="wrapper">
		<div class="container" style="margin-top: 20px;">
			<h3 class="col-md-offset-5">Đăng Bài tuyển dụng mới</h3>
		</div>
		<div class="container"
			style="margin-top: 45px; background: #fff; width: 900px;">
			<html:form action="/them-tuyendung?submit=submit">
					...
					<div class="row col-md-10">
						<div class="row">
							<div class="form-group col-md-12" style="margin-top: 10px;">
								...
								<html:text name="themBaiTuyenDungForm" property="tieuDe"
									styleClass="form-control" maxlength="100"></html:text>
								<p style="color: red">
						...
						<div class="row">
							<div class="form-group col-md-6">
								<div>
									<label>Han Nộp Hồ sơ (<span style="color: red">*</span>)</label>
								...
								<div class="form-group col-md-12">
									...
									<html:text name="themBaiTuyenDungForm"
										property="tenNguoiNhanHoSo" styleClass="form-control" maxlength="50"></html:text>
								</div>
							</div>
							<div>
								<div class="form-group col-md-6">
									...
									<html:text name="themBaiTuyenDungForm" property="soDienThoai"
										styleClass="form-control" maxlength="13"></html:text>
									<p style="color: red">
						...
						<hr>
						<div class="form-group col-md-12">
							<html:submit property="submit" alt="Thêm Bài Tuyển Dụng"
								styleClass="btn btn-success">Thêm Bài tuyển dụng</html:submit>
